...
async function handleWilyai({
	hisoka, m, query, tolak, logCommand, loadConfig, getUserName,
	getSessionKey, getHistory, clearHistory, addToHistory, buildHistoryMeta,
	getMediaTypeFromMessage, getQuotedMediaBuffer, downloadMediaBuffer,
	processAIMediaAndSend, wilyLog, wilyError,
	detectImageSearchQuery, extractImageCount, buildSmartImageWaitText,
	searchAndGetImages, buildSmartAlbumCaptions, sendImageAlbum, buildSmartImageHistoryReply,
	rememberAIMedia, getCachedQuotedMedia, getMediaInfo,
	detectAndUpdateMemory, buildWilyAICommandPrompt, buildWilyMediaUserPrompt, wrapCurrentUserMessage,
	startTyping, extractPdfText, parseZipBuffer, gemini,
}) {
	try {
