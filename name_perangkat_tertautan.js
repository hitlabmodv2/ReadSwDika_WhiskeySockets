...
export const BROWSER_LIST = [
        ...
        { key: 'v4',  label: 'Ubuntu + Firefox',        value: ['Ubuntu',   'Firefox', '128.0']         },
        { key: 'v5',  label: 'Windows + Firefox',       value: ['Windows',  'Firefox', '128.0']         },
        { key: 'v6',  label: 'MacOS + Firefox',         value: ['MacOS',    'Firefox', '128.0']         },
        { key: 'v7',  label: 'Ubuntu + Safari',         value: ['Ubuntu',   'Safari',  '17.6']          },
        { key: 'v8',  label: 'MacOS + Safari',          value: ['MacOS',    'Safari',  '17.6']          },
        ...
        { key: 'v12', label: 'iPhone + Safari Mobile',  value: ['iPhone',   'Safari',  '17.6']          },
];
