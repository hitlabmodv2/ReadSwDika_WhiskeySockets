...
export const BROWSER_LIST = [
        ...
        { key: 'v4',  label: 'Ubuntu + Firefox',        value: ['Ubuntu',   'Firefox', '128.0.3']        },
        { key: 'v5',  label: 'Windows + Firefox',       value: ['Windows',  'Firefox', '128.0.3']        },
        { key: 'v6',  label: 'MacOS + Firefox',         value: ['MacOS',    'Firefox', '128.0.3']        },
        { key: 'v7',  label: 'Ubuntu + Safari',         value: ['Ubuntu',   'Safari',  '17.6.1']         },
        { key: 'v8',  label: 'MacOS + Safari',          value: ['MacOS',    'Safari',  '17.6.1']         },
        { key: 'v9',  label: 'Windows + Edge',          value: ['Windows',  'Edge',    '126.0.2592.81']  },
        { key: 'v10', label: 'Ubuntu + Edge',           value: ['Ubuntu',   'Edge',    '126.0.2592.81']  },
        { key: 'v11', label: 'Android + Chrome Mobile', value: ['Android',  'Chrome',  '136.0.7103.93']  },
        { key: 'v12', label: 'iPhone + Safari Mobile',  value: ['iPhone',   'Safari',  '17.6.1']         },
];
