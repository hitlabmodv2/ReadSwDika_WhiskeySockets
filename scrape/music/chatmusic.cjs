 ...
 * ───────────────────────────────
 *
 *  chatmusic.cjs — Pencari & kirim musik (v1)
...
module.exports = { ChatMusicAPI, MODELS, formatDuration, buildCaption, _GENRES, _GENRES_JP, _GENRES_EN, handleMusikai, handleMusikai2 };
