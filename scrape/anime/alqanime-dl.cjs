...
/**
 * ═══════════════════════════════════════════════════════════════
 *  AlqAnime Episode Downloader
 *  Scrape & kirim link download episode anime Sub Indo dari
 *  AlqAnime — mendukung berbagai resolusi (360p, 480p, 720p)
 *  dan pengiriman langsung ke chat WhatsApp.
 * ═══════════════════════════════════════════════════════════════
 */
'use strict';
