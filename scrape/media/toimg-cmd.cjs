 ...
 * ───────────────────────────────
 *
 *  toimg-cmd.cjs — Sticker to image command
 *  Perintah .toimg untuk konversi stiker WebP menjadi file gambar
 * ───────────────────────────────
 */
/**
 * ═══════════════════════════════════════════════════════════════
 *  Sticker to Image Command (.toimg)
 *  Konversi stiker WebP menjadi gambar PNG/JPEG biasa —
 *  cukup reply stiker dengan .toimg dan bot akan kirim balik
 *  gambarnya dalam format yang bisa disimpan.
 * ═══════════════════════════════════════════════════════════════
 */
'use strict';
