 ...
 * ───────────────────────────────
 *
 *  youtube-dl.cjs — Downloader YouTube (.ytmp3/.ytmp4)
 *  Download audio/video YouTube via yt-dlp
 * ───────────────────────────────
 */
'use strict';
...
async function handleYtmp3(hisoka, m, query, ctx) {
    ...
    const { getDiskUsage, clearTmpFolder: clearTmpForYtmp3 } = await import('../../src/helper/cleaner.js');
...
async function handleYtmp4(hisoka, m, query, ctx) {
    ...
    const { getDiskUsage: getDiskYtmp4, clearTmpFolder: clearTmpForYtmp4 } = await import('../../src/helper/cleaner.js');
