...
async function handleWily({
        ...
        if (!userQuestion && !hasMedia && !quotedTextContext) {
                ...
                helpText += `│ ✅ Analisis video\n`;
                helpText += `│ ✅ Kirim lagu/MP3 otomatis\n`;
                helpText += `│ ✅ Download TikTok (tanpa watermark)\n`;
                helpText += `│ ✅ Download Instagram (reel/foto/album)\n`;
                helpText += `│ ✅ Download Facebook (video/reel)\n`;
                helpText += `│ ✅ Download YouTube video/MP3 dari URL\n`;
                helpText += `│ ✅ Jawab pertanyaan umum\n`;
                helpText += `│\n`;
                helpText += `│ *DOWNLOAD VIA .wily:*\n`;
                helpText += `│ Kirim link lalu minta download:\n`;
                helpText += `│ _"https://vm.tiktok.com/xxx download"_\n`;
                helpText += `│ _"https://instagram.com/reel/xxx simpan"_\n`;
                helpText += `│ _"https://fb.watch/xxx download"_\n`;
                helpText += `│ _"https://youtu.be/xxx minta mp3-nya"_\n`;
                helpText += `│\n`;
                helpText += `╰══════════════════════╯`;
