 ...
 * ───────────────────────────────
 *
 *  log-cmd.cjs — Command log helper
 *  Fungsi logging perintah bot dan tampilan log box di terminal
 * ───────────────────────────────
 */
/**
 * ═══════════════════════════════════════════════════════════════
 *  Command Log Helper
 *  Catat setiap perintah yang dieksekusi ke terminal dengan
 *  tampilan box berwarna — memudahkan debugging dan monitoring
 *  aktivitas bot secara real-time di console.
 * ═══════════════════════════════════════════════════════════════
 */
'use strict';
...
function makeLogCmd({ maskNumber }) {
        function _logCmdBox(m, hisoka, cmdStr) {
                ...
                const _namaGrup = m.isGroup
                        ? (m.groupSubject || hisoka.getName?.(m.from) || m.from?.split('@')[0] || '-')
                        : '-';
