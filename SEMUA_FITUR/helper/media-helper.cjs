 ...
 *  Kumpulan fungsi pembantu untuk pengolahan media: compress
 *  gambar, convert format, resize, dan ekstrak buffer dari
 *  pesan WA — digunakan oleh banyak fitur yang butuh media.
 * ═══════════════════════════════════════════════════════════════
 */
'use strict';
