...
if (issues.length === 0) {
        ...
        console.log(`${GRN}Semua case sudah pakai pola simple delegate ke SEMUA_FITUR/.${RST}\n`);
        process.exit(0);
}
...
for (const issue of issues) {
        ...
        console.log(`${DIM}  Rekomendasi: pindahkan ke SEMUA_FITUR/<folder-sesuai-fitur>/<nama>.cjs${RST}`);
...
console.log(`${RED}Total: ${issues.length} case perlu dimigrasikan ke SEMUA_FITUR/.${RST}\n`);
process.exit(1);
