...
async function main() {
        ...
        if (pairingNumber && !hisoka.authState.creds?.registered) {
                try {
                        ...
                        const _bKeyPair  = (global.__activeBrowserKey || 'v1').toLowerCase();
                        const _bInfoPair = BROWSER_LIST.find(b => b.key === _bKeyPair);
                        const _bLblPair  = _bInfoPair ? _bInfoPair.label : (global.__activeBrowserArr ? global.__activeBrowserArr.slice(0,2).join(' + ') : 'Chrome');

                        console.log('');
                        console.log(`${cyan}╔══════════════════════════════════╗${reset}`);
                        console.log(`${cyan}║${reset}  ${bold}${green}🤖  W H A T S A P P  P A I R I N G${reset}  ${cyan}║${reset}`);
                        console.log(`${cyan}╠══════════════════════════════════╣${reset}`);
                        console.log(`${cyan}║${reset}  ${yellow}📱${reset} Nomor  : ${bold}${cyan}${phoneInfo.formatted}${reset}`);
                        console.log(`${cyan}║${reset}  ${phoneInfo.flag} Negara : ${bold}${green}${phoneInfo.region}${reset} (${yellow}+${phoneInfo.countryCode}${reset})`);
                        console.log(`${cyan}║${reset}  ${yellow}🖥️${reset}  Browser: ${bold}${white}${_bLblPair}${reset}`);
                        console.log(`${cyan}╠══════════════════════════════════╣${reset}`);
                        console.log(`${cyan}║${reset}`);
                        console.log(`${cyan}║${reset}  ${bold}${yellow}🔑 KODE PAIRING (copy baris ini):${reset}`);
                        console.log(`${cyan}║${reset}`);
                        console.log(`${cyan}║${reset}    ${bold}${green}┌────────────────────┐${reset}`);
                        console.log(`${cyan}║${reset}    ${bold}${green}│  ${reset}${bold}\x1b[97m${formattedCode}${reset}${bold}${green}  │${reset}`);
                        console.log(`${cyan}║${reset}    ${bold}${green}└────────────────────┘${reset}`);
                        console.log(`${cyan}║${reset}`);
                        console.log(`${cyan}╠══════════════════════════════════╣${reset}`);
                        console.log(`${cyan}║${reset}  ${bold}${yellow}📋 CARA PAIRING${reset}`);
                        console.log(`${cyan}║${reset}  ${green}1.${reset} Buka WhatsApp di HP`);
                        console.log(`${cyan}║${reset}  ${green}2.${reset} Ketuk ${bold}${yellow}⋮${reset} → ${bold}${yellow}Perangkat Tertaut${reset}`);
                        console.log(`${cyan}║${reset}  ${green}3.${reset} Ketuk ${bold}${yellow}Tautkan Perangkat${reset}`);
                        console.log(`${cyan}║${reset}  ${green}4.${reset} Pilih ${bold}${cyan}Tautkan dgn nomor telepon${reset}`);
                        console.log(`${cyan}║${reset}  ${green}5.${reset} Masukkan kode: ${bold}${green}${formattedCode}${reset}`);
                        console.log(`${cyan}╠══════════════════════════════════╣${reset}`);
                        console.log(`${cyan}║${reset}  ${dim}•${reset} Kode berlaku ${yellow}3 menit${reset} — restart jika expired`);
                        console.log(`${cyan}║${reset}  ${dim}•${reset} Pastikan HP terhubung internet`);
                        console.log(`${cyan}╠══════════════════════════════════╣${reset}`);
                        console.log(`${cyan}║${reset}  ${bold}${green}✅ Kode berhasil dibuat!${reset}`);
                        console.log(`${cyan}║${reset}  ${yellow}⏳ Menunggu konfirmasi WA...${reset}`);
                        console.log(`${cyan}╚══════════════════════════════════╝${reset}`);
                        console.log('');
                } catch {
